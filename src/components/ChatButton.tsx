...
//       onClick={openChat}
//       className="fixed bottom-6 right-6 flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 shadow-lg transition-transform hover:scale-110"
//     >
//       <svg
...
//         <path
//           d="M31.1394 3.44444C31.2887 5.19796 31.7497 6.46368 32.5224 7.32746C33.3107 8.25415 35.1578 8.85488 36.5945 8.90117V10.2986C35.1575 10.3449 33.3105 10.9454 32.5224 11.8723C31.7499 12.7361 31.2887 14.0005 31.1394 15.7537H29.742C29.5927 14.0005 29.1314 12.7361 28.359 11.8723C27.5709 10.9458 25.7238 10.3449 24.2868 10.2986V8.90117C25.7236 8.85488 27.5707 8.25415 28.359 7.32746C29.1317 6.46368 29.5927 5.19796 29.742 3.44444H31.1394Z"
//           fill="#FBFBFB"
//         />
...
//     <button
//       type="button"
//       className="fixed bottom-10 right-10 z-[9999] h-16 w-16 rounded-full bg-blue-600 text-3xl text-white shadow-2xl"
