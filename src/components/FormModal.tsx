                    ...
                    >
                        <div className="mb-6 flex items-start justify-between gap-4">
                            <div>
                                <p className="text-xs font-medium uppercase tracking-wider text-sky-600">
                                    {type === "create" ? "New record" : type === "update" ? "Edit record" : "Delete record"}
                                </p>
                                <h2 id="form-modal-title" className="mt-1 text-xl font-semibold text-gray-800">
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {fields.map((field) => {
                                ...
                                const isLongText = field === "description" || field === "address";
                                return (
                                    <label key={field} className={isLongText ? "sm:col-span-2" : ""}>
